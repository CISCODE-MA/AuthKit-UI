          ...
          <div className="mb-6">
            <div className="flex items-center gap-3 rounded-lg bg-green-50 border border-green-200 p-4 text-green-800">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm13.036-3.286a.75.75 0 10-1.072-1.048l-4.58 4.687-2.101-2.102a.75.75 0 10-1.06 1.06l2.63 2.631a.75.75 0 001.079-.012l5.104-5.216z"
                  clipRule="evenodd"
                />
              </svg>
              <div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                title={t('VerifyEmailPage.resendDisabledTip', {
                  defaultValue: 'Resend endpoint not configured',
                })}
              >
